...
namespace ItemDoc.Framework.Repositories
{
  ...
  public static class PageListExtensions
  {
    ...
    public static PageList<T> ToPagedList<T>(this Page<T> list, int pageIndex, int pageSize) where T : class
    {
      var pageList = new PageList<T>()
      {
        ...
        PageSize = pageSize,
        Items = list.Items,
        TotalCount = (int)list.TotalItems,
        Context = list.Context

      };
      pageList.AddRange(list.Items);
      return pageList;
    }

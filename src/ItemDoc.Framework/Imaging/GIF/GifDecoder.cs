...
namespace ItemDoc.Framework.Imaging.Gif
{
    /// <summary>
    /// 
    /// </summary>
    public class GifDecoder
    {
        ...
        /// <summary>
        /// 延迟毫秒// delay in milliseconds
        /// </summary>
        protected int delay = 0;
        /// <summary>
        /// 透明色指数 // transparent color index
        /// </summary>
        protected int transIndex;

        /// <summary>
        /// 最大像素数max decoder pixel stack size
        /// </summary>
        ...
        /// n帧的图像内容
        /// </summary>
        /// <param name="n">//缓冲图像表示的框架,或null如果n是无效的。</param>
        /// <returns></returns>

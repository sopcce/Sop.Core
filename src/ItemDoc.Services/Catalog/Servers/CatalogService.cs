...
namespace ItemDoc.Services.Servers
{
  public class CatalogService : ICatalogService
  {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public CatalogInfo Get(object id)
    {
      return _repository.GetById(id.ToString());
    }

    public IEnumerable<CatalogInfo> GetByItemId(string id)
    {
    ...
    {
      CatalogInfo info = _repository.GetById(CategoryId);
      if (info == null)
        return null;
    ...
    public void Merge(int fromCategoryId, int toCategoryId)
    {
      ...
      _repository.Update(toCategory);
      _repository.Delete(fromCategory);
    }

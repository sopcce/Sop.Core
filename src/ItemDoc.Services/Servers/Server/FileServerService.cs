...
using ItemDoc.Services.Repositories.Repository;
...
namespace ItemDoc.Services.Servers
{
  ...
  {
    private readonly IFileServerRepository _repository;
    public FileServerService(IFileServerRepository repository)
    {

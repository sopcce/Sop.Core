...
; (function (factory) {
    ...
    editormd.version = "1.5.2"; //Math.random(); //"1.5.2.2" ;
                    ...
                    if (faMatchs) {
                        ...
                        if (emdlogoMathcs) {
                            ...
                            for (var t1 = 0, len4 = itemdocMatchs.length; t1 < len4; t1++) {
                                ...
                                return "<img src=\"" + editormd.Sop.path + itemdoc + editormd.Sop.ext + "\" title=\"itemdoc-" + itemdoc + "\" alt=\"itemdoc-" + itemdoc + "\" class=\"emoji itemdoc\" />";
                            }
                        }
                        //TODO ：暂时这样 后期在处理
                        else {

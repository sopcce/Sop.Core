...
namespace Sop.FileServer.Spider
{
    public class Spider1
    {
        ...
        public DownloaderEnum DownloaderEnum { get; set; } = DownloaderEnum.Chrome;



        public Spider1(DownloaderEnum downloader)
        {
            this.DownloaderEnum = downloader;
            wd = InitWebDriver();
        }
        ...
        private QA.IWebDriver InitWebDriver()
        {
            ...
            switch (this.DownloaderEnum)
            {
                case DownloaderEnum.Ie:

                    QA.IE.InternetExplorerOptions ieOptions = new QA.IE.InternetExplorerOptions();
                    ieOptions.IntroduceInstabilityByIgnoringProtectedModeSettings = true;
                    theDriver = new QA.IE.InternetExplorerDriver(ieOptions);

                    break;
                case DownloaderEnum.Chrome:

                    theDriver = new QA.Chrome.ChromeDriver();

                    break;
                case DownloaderEnum.Firefox:

                    theDriver = new QA.Firefox.FirefoxDriver();

                    break;
                case DownloaderEnum.Safari:

                    theDriver = new QA.Safari.SafariDriver();

                    break;
                case DownloaderEnum.PhantomJs:

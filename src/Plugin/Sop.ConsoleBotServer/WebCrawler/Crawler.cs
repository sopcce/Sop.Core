...
using Sop.ConsoleBotServer.Events;
...
namespace Sop.ConsoleBotServer.WebCrawler
{
    /// <summary>
    ...
    public class Crawler
    {
        ...
        public void Start(string url, CrawlSettings settings)
        {
            Task.Run(() =>
           {
               ...
               var tempPath = FileUtility.Combine(homePath, "pdf2temp");
               ...
               {
                   Console.WriteLine("---erop :" + ex.Message);
               }
               finally
               {
                   driver.Close();

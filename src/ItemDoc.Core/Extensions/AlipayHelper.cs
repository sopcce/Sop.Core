...
namespace Com.Alipay
{
    ...
    public class AlipayHelper
    {
        ...
        /// </summary>
        /// <param name="out_trade_no">商户订单号，商户网站订单系统中唯一订单号，必填；
        ...
        /// <param name="total_fee">付款金额，必填；注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</param>
        /// <param name="body">商品描述，可空；商品描述(body)，选填(建议中文，英文，数字，不能含有特殊字符)</param>
        /// <returns></returns>
        public static string SetSubmit(string out_trade_no, string subject, string total_fee, string body)
        {
            //把请求参数打包成数组
            ...
            sParaTemp.Add("out_trade_no", out_trade_no.Trim());
            sParaTemp.Add("subject", subject.Trim());
            sParaTemp.Add("total_fee", total_fee.Trim());

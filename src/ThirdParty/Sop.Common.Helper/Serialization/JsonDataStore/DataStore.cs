...
namespace Sop.Common.Helper.Serialization.JsonDataStore
{
    public class DataStore : IDataStore
    {
        ...
        public DataStore(string path, bool useLowerCamelCase = true, string keyProperty = null, bool reloadBeforeGetCollection = false)
        {
            ...
            Task.Run(() =>
            {
                ...
                while (!token.IsCancellationRequested)
                {
                    ...
                    {
                        var (actionSuccess, updatedJson) = action.GetHandleAction()(JObject.Parse(jsonText));
        ...
        private async Task<bool> CommitItem(Func<(bool, JObject)> commitOperation, bool isOperationAsync)
        {
            ...
            commitAction.SetHandleAction(new Func<JObject, (bool success, string json)>(currentJson =>
            {
        ...
        private class CommitAction
        {
            ...
            private Func<JObject, (bool success, string json)> _handleAction;

            public Func<JObject, (bool success, string json)> GetHandleAction()
            {
                return _handleAction;
            }

            public void SetHandleAction(Func<JObject, (bool success, string json)> value)
            {
                _handleAction = value;
            }
        }

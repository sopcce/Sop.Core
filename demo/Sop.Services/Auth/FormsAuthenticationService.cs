...
namespace ItemDoc.Services.Auth
{
  ...
  public class FormsAuthenticationService : IAuthenticationService
  {
    ...
    public void SetCurrentAccount(UsersInfo user)
    {
      ...
      var cookieValue = EncryptionUtility.AES_Encrypt(user.Id);
    ...
    public UsersInfo GetCurrentUser()
    {
      ...
      bool isok = !Convert.ToString(account.Id).Equals(theuserid, StringComparison.OrdinalIgnoreCase);
